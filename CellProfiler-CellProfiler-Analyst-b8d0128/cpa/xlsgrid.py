...
# Latest Revision: 24 Aug 2011, 22.00 GMT
#
#
# TODO List
#
...
Sample usage::
    ...
    app = wx.PySimpleApp()
    frame = wx.Frame(None, -1, size=(1000, 800))
...
1. XLSGrid is sufficiently efficient and fast for reasonably small Excel files.
   There might be some improvement to be made in the code to make it work with
   bigger files and in a faster way;
...
Latest Revision: Andrea Gavana @ 24 Aug 2011, 22.00 GMT
...
class TransientPopup(STT.SuperToolTip):
    """
    This is a sublass of `wx.lib.agw.supertooltip` and it is used to display a
